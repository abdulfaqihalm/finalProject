    ...
    _onSubmit(e) {
        ...
        upload(formData).then( response => {
            if(response.error==="") {
                ...
                setTimeout(() =>{this.props.history.push({pathname: '/brain/annotator', state:response.filename})} ,0)
            }
            else{
            ...
            <div className="row">
              <div className="col-md-6 mt-5 mx-auto">
                <form noValidate onSubmit={this._onSubmit}>
                  <h1 className="h3 mb-3 font-weight-normal">Please upload .mat file</h1>
